...
public class LibroDAOImpl implements LibroDAO {
    ...
    public List<Libro> listarDisponibles() throws SQLException {
        ...
        try (
                Connection conn = Conexion.getConnection(); PreparedStatement stmt = conn.prepareStatement(sql); ResultSet rs = stmt.executeQuery()) {
    ...
    public Libro buscarLibro(String isbn) {
        ...
        try (
                Connection conn = Conexion.getConnection(); PreparedStatement stmt = conn.prepareStatement(sql)) {
